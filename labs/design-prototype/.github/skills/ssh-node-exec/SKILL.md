...
```powershell
# 1. Leer .github/skills/ssh-node-exec/.env → root=<usuario@host>, pasword=<password>
...
run_in_terminal mode=async:
   .github\skills\ssh-node-exec\references\ssh-connect.ps1 -domain "<usuario@host>" -pass "<password>" -path "D:\Programacion_Extra\ldl"
...
send_to_terminal id=abc-111: <password>
