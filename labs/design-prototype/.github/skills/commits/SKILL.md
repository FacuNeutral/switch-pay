...
- Calcular version semver y actualizar `package.json`.
...
4. **Calcular version** — seguir el flujo de versionado definido en [reference.md](reference.md) (leer version actual, calcular bump, verificar alpha, actualizar `package.json`).
...
- Version actualizada en `package.json` cuando corresponda.
