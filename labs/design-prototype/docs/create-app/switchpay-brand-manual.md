...
- **Primary** � isotipo en `primary` sobre fondo claro o `neutral-surface-dark`.
...
sostenidos por una base neutral c�lida que funciona en dark y light. Los valores
de esta secci�n deben coincidir con la paleta declarada en la devtool
`brand-design` (`BRAND_COLOR_GROUPS`).
...
| `primary-foreground` | `#F4F8F7` | Texto sobre `bg-primary`                   |
...
| `accent-foreground`| `#F4F8F7`  | Texto sobre `bg-accent`                     |
...
| Token                 | HEX        | Uso                                |
| --------------------- | ---------- | ---------------------------------- |
| `neutral`             | `#F4F8F7`  | Fondo base claro                   |
...
| Token                 | HEX        | Uso                                |
| --------------------- | ---------- | ---------------------------------- |
| `neutral-dark`        | `#09090B`  | Fondo base oscuro                  |
| `neutral-surface-dark`| `#18181B`  | Surfaces elevadas, cards           |
| `neutral-card-dark`   | `#141416`  | Cards sobre surfaces, modales      |
| `neutral-line-dark`   | `#27272A`  | Bordes dark                        |
| `neutral-muted-dark`  | `#71717A`  | Texto secundario en dark           |
| `neutral-ink-dark`    | `#F4F8F7`  | Texto principal en dark            |
...
- Texto sobre `primary` usa `primary-foreground` (`#F4F8F7`).
- Texto sobre `accent` usa `accent-foreground` (`#F4F8F7`).
- Texto principal sobre fondos claros usa `neutral-ink` (`#102021`).
- Texto principal sobre fondos oscuros usa `neutral-ink-dark` (`#F4F8F7`).
...
4. **Texto sobre primary** siempre `primary-foreground` (`#F4F8F7`).
