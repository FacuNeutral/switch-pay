...
4. Si se agregan o cambian tokens, consultar [reference.md](reference.md) y actualizar `design-token.md` cuando corresponda.
...
- [ ] Los nuevos tokens estan en `index.css` dentro de `@theme inline` y documentados en `design-token.md`.
